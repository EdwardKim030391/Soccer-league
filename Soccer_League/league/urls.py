...
from .views import (
    ...
    add_player, edit_player, select_team, simulate_matches,
    simulate_season, dashboard, league_standings, match_list
)
...
urlpatterns = [
    ...
    path("select_team/", login_required(select_team), name="select_team"),
